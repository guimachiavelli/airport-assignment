...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__scss_main_scss__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__slider__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__reveal__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shrink_header__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__player__ = __webpack_require__(26);
...
function main() {
  var sliderEl = document.querySelector('.slider-container');
  var slider = new __WEBPACK_IMPORTED_MODULE_1__slider__["a" /* default */](sliderEl);
  slider.setup();

  var blockquote = document.querySelector('.article__quote');
  var revealQuote = new __WEBPACK_IMPORTED_MODULE_2__reveal__["a" /* default */](blockquote);
  revealQuote.setup();

  var statistics = document.querySelector('.statistics');
  var revealStatistics = new __WEBPACK_IMPORTED_MODULE_2__reveal__["a" /* default */](statistics, 0.5);
  revealStatistics.setup();

  var header = document.querySelector('.site-header');
  var shrinkHeader = new __WEBPACK_IMPORTED_MODULE_3__shrink_header__["a" /* default */](header);
  shrinkHeader.setup();

  var playerEl = document.querySelector('.player');
  var player = new __WEBPACK_IMPORTED_MODULE_4__player__["a" /* default */](playerEl);
  player.setup();
}
...
var Slider = function () {
  function Slider(el) {
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, Slider);
  ...
  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(Slider, [{
    key: 'setup',
    ...
    key: 'slide',
    value: function slide(newIndex, oldIndex) {
      this.index = newIndex;
    ...
    key: 'resetSlide',
    value: function resetSlide(oldIndex) {
      var _this = this;
      ...
      setTimeout(function () {
        _this.slideContainer.className = cachedClass;
        setTimeout(function () {
          _this.slide(_this.index + 1, _this.index);
        }, 20);
      }, 20);
    }
  }]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helpers__ = __webpack_require__(24);
...
var Reveal = function () {
  function Reveal(el, delay) {
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, Reveal);
  ...
  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(Reveal, [{
    key: 'setup',
    value: function setup() {
      if (Object(__WEBPACK_IMPORTED_MODULE_2__helpers__["a" /* isElementOnScreen */])(this.el, 1)) {
        return;
      }
    ...
    value: function handleScroll() {
      if (!Object(__WEBPACK_IMPORTED_MODULE_2__helpers__["a" /* isElementOnScreen */])(this.el, this.delay)) {
        return;
      }
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return isElementOnScreen; });
function isElementOnScreen(el, delay) {
  var winHeight = window.innerHeight;
  var bounds = el.getBoundingClientRect();
  var elDistanceFromTop = bounds.top - winHeight * delay;
  console.log(delay);
...
var ShrinkHeader = function () {
  function ShrinkHeader(el) {
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, ShrinkHeader);
  ...
  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(ShrinkHeader, [{
    key: 'setup',
    value: function setup() {
      window.addEventListener('scroll', this.handleScroll);
    }
...
/* harmony default export */ __webpack_exports__["a"] = (ShrinkHeader);
